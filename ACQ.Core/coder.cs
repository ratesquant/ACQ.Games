...
namespace Kamlex.Core
{
    ...
    public class coder
    {
        ...
        public static void Test()
        {
            ...
            Console.WriteLine("Before Compression :" + test);
            Console.WriteLine("Compressed ({0}) bytes : {1}", mem_test.Length, compressed);
            Console.WriteLine("Expanded :" + expand_test);
            ...
            Console.WriteLine(" Before Compression :" + test);
            Console.WriteLine(" Compressed (" + mem_test.Length + " bytes) :\n" + compressed);
            Console.WriteLine(" Expanded :" + expand_test);
        }
    }
}
