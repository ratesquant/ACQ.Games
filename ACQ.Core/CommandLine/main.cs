...
class WCArguments
{
    [ArgumentAttribute(ArgumentType.AtMostOnce, DefaultValue=true, HelpText="Count number of lines in the input text.")]
    public bool lines;
    [ArgumentAttribute(ArgumentType.AtMostOnce, DefaultValue=false, HelpText = "Count number of words in the input text.")]
    public bool words;
    [ArgumentAttribute(ArgumentType.AtMostOnce, HelpText="Count number of chars in the input text.")]
    public bool chars;
    [DefaultArgumentAttribute(ArgumentType.MultipleUnique, DefaultValue= new string[] {"a", "b"}, HelpText="Input files to count.")]
    public string[] files;
}
